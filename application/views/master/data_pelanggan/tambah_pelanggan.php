                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= site_url('master/pelanggan/fungsi_tambah') ?> " method="POST">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="kode_pelanggan">Kode Pelanggan </label>
                                                <input type="text" class="form-control" id="kode_pelanggan" name="kode_pelanggan" value="<?= $kode_pelanggan ?>" readonly>
                                                <?= form_error('kode_pelanggan', '<small class="text-danger pl-3">', '</small>') ?>
                                            </div>
                                            <div class="form-group">
