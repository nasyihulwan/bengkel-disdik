          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <?= form_open_multipart('master/service/export_excel_mobil'); ?>
                          ...
                          <td>
                            <div class="btn-group container">
                              ...
                              <?php if ($this->session->userdata('role_id') == 1) { ?>
                                <a href="<?= site_url('master/service/fungsi_deleteMobil') ?>/<?= $row->kode_service ?>" class="btn btn-sm btn-danger"><i class="fa-solid fa-trash-can"></i> Delete</a>
                              <?php } ?>
                            </div>
                          </td>
                        </tr>
