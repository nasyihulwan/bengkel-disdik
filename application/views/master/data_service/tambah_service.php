          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <form action="<?= site_url('master/service/fungsi_tambah') ?>" method="POST">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="nama">Nama </label>
                        <input type="text" class="form-control" id="kode_service" name="kode_service" value="<?= $kode_service ?>" readonly>
                      </div>
                      <div class="form-group">
                        <label for="nama">Nama </label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tipe_kendaraan" name="tipe_kendaraan" placeholder="Tipe Kendaraan" required>
                      </div>
                      <div class="form-group">
