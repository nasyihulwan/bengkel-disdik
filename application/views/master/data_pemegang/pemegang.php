                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="small-box bg-primary">
                                ...
                                <a href="<?= site_url('master/pemegang/mobil') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="<?= site_url('master/pemegang/motor') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                    </div>
