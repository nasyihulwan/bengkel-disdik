                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <?= form_open_multipart('master/pemegang/export_excel_motor'); ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group container">
                                                            ...
                                                            <?php if ($this->session->userdata('role_id') == 1) { ?>
                                                                <a href="<?= site_url('master/pemegang/fungsi_deleteMotor') ?>/<?= $row->kode_pemegang ?>" class="btn btn-sm btn-danger"><i class="fa-solid fa-trash-can"></i> Delete</a>
                                                            <?php } ?>
                                                        </div>
                                                    </td>
                                                </tr>
