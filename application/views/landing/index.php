...
<body>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-heading">
                        ...
                        <p>Kami merupakan Bengkel kendaraan yang siap melayani 24 Jam. Kami hadir dan siap datang untuk
                            melayani dan membantu pelanggan yang mengalami permasalahan teknis pada kendaraanya dimana
                            pun anda berada. Kami siap membantu anda memberikan kemudahan untuk SERVICE PERAWATAN &
                            SERVICE PERBAIKAN KENDARAAN di Tempat Anda untuk kendaraan Injection Jepang, Eropa, Korea.
                            Kami melayani area Bandung Raya ( Kota Bandung, Cimahi, Lembang, Padalarang, Soreang,
                            Ciwidey, Cileunyi dan sekitarnya ). Silahkan Konsultasikan terlebih dahulu keluhan dan
                            permasalahan Mobil anda. Di bawah ini adalah beberapa layanan dari NTRD GARAGE, Semua
                            pekerjaan di NTRD GARAGE dikerjakan oleh tenaga ahli yang berpengalaman dan profesional.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" id="our-classes">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <p>Dibawah ini adalah beberapa layanan yang ada di NTRD GARAGE. Semua pekerjaan dikerjakan oleh
                            tenaga ahli yang berpengalaman dan profesional.</p>
                    </div>
                </div>
            </div>
            <div class="row" id="tabs">
                <div class="col-lg-4">
                    <ul>
                        <li><a href='#tabs-1'><img src="<?= base_url('dist/img/landing/kuncipas.png') ?> "
                                    alt="">Perawatan Rutin</a></li>
                        <li><a href='#tabs-2'><img src="<?= base_url('dist/img/landing/kuncipas.png') ?> "
                                    alt="">Service Kecil</a></a></li>
                        <li><a href='#tabs-3'><img src="<?= base_url('dist/img/landing/kuncipas.png') ?> "
                                    alt="">Service Besar</a></a></li>
                        <li><a href='#tabs-4'><img src="<?= base_url('dist/img/landing/kuncipas.png') ?> " alt="">Dan
                                Lainnya</a></a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg col-md-6 col-xs-12">
                    <div id="map">
                        <center><iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126748.60912443619!2d107.5731163132953!3d-6.903273916440719!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e6398252477f%3A0x146a1f93d3e815b2!2sBandung%2C%20Kota%20Bandung%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1657522033470!5m2!1sid!2sid"
                                width="1350" height="1000" style="border:0;" allowfullscreen="" loading="lazy"
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; 2022 <?= SITE_NAME ?>

                        - Designed by <a rel="nofollow" href="https://templatemo.com/" class="tm-text-link"
                            target="_blank">TemplateMo</a>.
                        Re-Design By <a rel="nofollow" href="https://github.com/nasyihulwan" class="tm-text-link"
                            target="_blank">Nasyih Ulwan</a>
                    </p>
