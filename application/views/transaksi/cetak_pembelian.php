        ...
        <section class="invoice">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="page-header">
                        ...
                        <small class="float-right"> <b>FAKTUR PEMBELIAN BARANG</b> </small>
                    </h2>
                </div>
            ...
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                    From
                    <address>
                        <strong><?= $pembelian['kode_supplier'] . '/' . $pembelian['nama_supplier'] ?></strong><br>
                        <?= $pembelian['alamat_supplier'] ?><br>
                        Phone: <?= $pembelian['notelp_supplier'] ?> <br>
                        Email: <?= $pembelian['email_supplier'] ?>
                    </address>
                </div>
                <div class="col-sm-4 invoice-col">
                    To
                ...
                <div class="col-sm-4 invoice-col">
                    ...
                    <br>
                    <b>Nomor Faktur:</b> <?= $pembelian['no_faktur'] ?><br>
                    <b>Tanggal Transaksi:</b> <?= $pembelian['tgl_transaksi'] ?><br>
                    <b>Kasir:</b> <?= $pembelian['id_user'] . '/' . $pembelian['nama_kasir'] ?>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <table class="ml-3">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p class="ml-3">Bengkel Disdik <br> <br> <br> <br> <br> ____________</p>
                                </td>
                                <td>
                                    <p class="ml-3"> Supplier <br> <br> <br> <br> <br> _________________</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-6">
                    <p class="lead">Jumlah Tagihan Yang Harus Dibayar </p>
                    <div class="table-responsive ">
                        <table class="table">
                            <tr>
                                <th style="width:50%">HARGA JUAL :</th>
                                <td><?= number_format($row->totalpembelian, '0', '', '.',) ?></td>
                            </tr>
                            <tr>
                                <th>TOTAL :</th>
                                <td><?= number_format($row->totalpembelian, '0', '', '.') ?></td>
