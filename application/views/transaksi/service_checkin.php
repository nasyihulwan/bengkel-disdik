                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" value="<?= date("Y-m-d") ?>" class="form-control tglTransaksi" name="tglTransaksi" placeholder="Tanggal Transaksi" readonly>
                        ...
                        <div class="card" id="dataKendaraan">
                            <div class="card-body">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="noPlatKend" id="noPlatKend" placeholder="Nomor Plat Kendaraan" value="<?= $kendaraan->no_regis_kendaraan ?>" readonly>
                                    <input type="hidden" class="form-control" id="kode_antri" value="<?= $kendaraan->kode_antri ?>" readonly>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    </div>
                                    <input type="hidden" name="kodePemegang" id="kodePemegang" value="<?= $kendaraan->kode_pemegang ?>">
                                    <input type="text" class="form-control" name="namaPemegang" id="namaPemegang" placeholder="Nama Pemegang" value="Nama Pemegang - <?= $kendaraan->nama_pemegang ?>" readonly>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    </div>
                                    <input type="text" class="form-control" name="namaPemilik" id="namaPemilik" placeholder="Nama Pemilik" value="Nama Pemilik - <?= $kendaraan->nama_pemilik ?>" readonly>
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="jenisKend" id="jenisKend" placeholder="Jenis Kendaraan" value="<?= $kendaraan->jenis_kendaraan ?>" readonly>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-tasks" aria-hidden="true"></i></span>
                                    </div>
                                    <input type="text" class="form-control" name="tipeKend" id="tipeKend" placeholder="Jenis Kendaraan" value="<?= $kendaraan->nama_tipe_kendaraan ?>" readonly>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-tachometer" aria-hidden="true"></i></span>
                                    </div>
                                    <input type="text" class="form-control" name="kilometer" id="kilometer" placeholder="Kilometer" value="<?= $kendaraan->kilometer ?>" readonly>
                                </div>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Keterangan</span>
                                    </div>
                                    <textarea name="keterangan" id="keterangan" cols="100" rows="2" readonly><?php echo htmlspecialchars($kendaraan->ket_booking); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table class="table table-striped table-bordered">
                            ...
                            <?php $no = 0;
                            foreach ($this->db->get_where('service', array('jenis_kendaraan' => $kendaraan->jenis_kendaraan))->result() as $row) {
                                $no++ ?>
                                <tbody>
                                    <td><?= $no ?></td>
    ...
    <script>
        ...
        $(function() {
            ...
            $("#tambahService").click(function() {
                ...
                var tipeKendaraan = $("#tipe_kendaraan").val();
                var idUser = $("#id_user").val();
            ...
            $("#simpanService").click(function() {
                ...
                if (totalPenj == 0 || totalPenj == null) {
                    ...
                    if (noFaktur == "") {
                        ...
                        Swal.fire({
                            title: 'Data Transaksi Service Berhasil Ditambahkan!',
