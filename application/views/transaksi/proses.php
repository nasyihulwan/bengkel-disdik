                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;"> <span class="badge bg-yellow "><?= $row->status ?></span> </td>
            ...
            $(".updateStatus").click(function() {
                ...
                $(".simpanPerubahan").click(function() {
                    if ($('#status').val() == 'Status') {
                        ...
                        valJamKeluar = $('#jam_keluar').val();

                        $.ajax({
                            type: 'POST',
                            url: '<?= site_url() ?>penjualan/transaksi/updateSelesai',
                            data: {
                                no_regis: platKendaraan,
                                no_faktur: noFaktur,
                                status: valStatus,
                            ...
                            success: function(respond) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        $.ajax({
                                            type: 'POST',
                                            url: '<?= site_url() ?>penjualan/transaksi/afterUpdateSelesai',
                                            data: {
                                                no_regis: platKendaraan,
                                                kilometer: valKilometer
                                            },
                                            cache: false
                                        });
                                        location.reload();
